...
export default function Home() {
  ...
  return (
    <main style={{ minHeight: "100vh", background: "linear-gradient(180deg, #4a1088 0%, #3d0e7a 20%, #26085a 42%, #120430 64%, #000000 82%, #000000 100%)", padding: "40px 24px", position: "relative", zIndex: 1 }}>
      <FallingHearts />
